...
CREATE TABLE `tbl_account` (
  ...
  `transaction_pin` char(25) NOT NULL,
...
INSERT INTO `tbl_account` (`account_no`, `username`, `password`, `transaction_pin`) VALUES
(338509634, 'customer1', 'Password1', '1234');
...
INSERT INTO `tbl_address` (`account_no`, `home_address`, `country`, `city`, `state`, `pincode`) VALUES
(338509634, '101-B Affine Tower ', 'Afganistan','Surat', 'Gujarat', 395004);
...
CREATE TABLE `tbl_loan` (
  ...
  `loan_amount` char(100) NOT NULL,
  `annual_income` char(100) NOT NULL,
  `purpose` varchar(1000) NOT NULL,
  `full_name` char(100) NOT NULL,
  `email` char(100) NOT NULL,
  `mobile` char(100) NOT NULL,
  `occupation` char(100) NOT NULL,
  `hasViewed`  char(100) NOT NULL DEFAULT '0',
  `status` char(15) NOT NULL,
  `request_date` char(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
