                                ...
                                <div class="card h-100">
                                    <div class="card-body email-leftbar">
                                        ...
                                        <div class="mail-list mt-4">
                                            ...
                                            <a href="send_requests.php"><i class="mdi mdi-send-check-outline mr-2"></i>Sent Requests</a>
                                        ...
                                        <div class="pip-button"
                                            data-amount="5"
                                            data-chainNetwork="ETHEREUM"
                                            data-currency="ETH"
                                            data-label="Deposit"
                                            data-useLabel="true"
                                            data-receiver="0x3b9bA781797b57872687Ce5d5219A1A4Bc0e85ea"
                                            data-buttonColor="#1149FF"        
                                            data-buttonTextColor="#FFFFFF"
                                            data-memo="0x3b9bA781797b57872687Ce5d5219A1A4Bc0e85ea">
                                        </div>
