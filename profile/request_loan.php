...
<script type="text/javascript">
  ...
  function amountLimit()
  {
    Swal.fire({
      title: "Can't Sent Request",
      text: "Limit of Add Money is 500 to 20,000",
      icon: "error"
    });
  }
</script>
...
<html lang="en">
    ...
    <body data-topbar="dark" data-layout="horizontal">
        ...
        <header id="page-topbar" style = "background-color: #00204a !important">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index.php" class="logo logo-light">
                                <span class="logo-sm text-white mb-0">
                                    <img src="assets/images/favicon.ico" alt="" height="22">
                                    NovaFinance 
                                </span>
                                <span class="logo-lg font-size-20 text-white mb-4">
                                    <img src="assets/images/favicon.ico" alt="" height="19">
                                    NovaFinance 
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="inbox.php">
                                        <i class="mdi mdi mdi-email-send-outline mr-2"></i>Add Money
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="request_loan.php">
                                        <i class="mdi mdi mdi-cash-multiple mr-2"></i>Take a Loan
                                    </a>
                                </li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Request Loan</h4>
                                    ...
                                    <div class="card-body">
                                        <form class="custom-validation" action="#" method="post">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="account_num" data-parsley-type="digits" type="text" class="form-control" required placeholder="Account Number"  value="<?php echo $row_customer['account_no'] ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="loan_amount" data-parsley-type="digits" type="text" class="form-control" required placeholder="Loan Amount"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="annual_income" data-parsley-type="digits" type="text" class="form-control" required placeholder="Annual Income"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="subject-input">Loan Purpose</label>
                                                <div>
                                                    <textarea name="purpose" required class="form-control" rows="5" required></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="fullname" data-parsley-type="text" type="text" class="form-control" required placeholder="Full Name" value="<?php echo $row_customer['full_name'] ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Email</label>
                                                <div>
                                                    <input name="email" data-parsley-type="email" type="text" class="form-control" required placeholder="Email"  value="<?php echo $row_customer['email'] ?>"/>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="mobile" data-parsley-type="digits" type="text" class="form-control" required placeholder="Phone Number"  value="<?php echo $row_customer['mobile'] ?>"/>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="occupation" data-parsley-type="text" type="text" class="form-control" required placeholder="Occupation"/>
                                                </div>
                                            </div>
                                            <p> <input type="checkbox" name="" id=""> I hereby agree that the information given is true, accurate and complete as of the date of this application submission.</p>
                                            ...
                                            <div class="btn-toolbar form-group mb-0">
                                                <div class="">
                                                    ...
                                                    <button name="btn_send" type="submit" class="btn btn-primary waves-effect waves-light"> <span>Request Loan</span> <i class="fab fa-telegram-plane ml-1"></i> </button>
                                                </div>
                                            </div>
...
<?php
    ...
    if(isset($_REQUEST['btn_send']))
    {
       // $Account_no = $_SESSION["s_account_no"];
        ...
        $query_for_check_To_Account_no = mysqli_query($con,"SELECT account_no FROM  tbl_account WHERE account_no=$account_num");
        $result_to_account = mysqli_num_rows($query_for_check_To_Account_no);

        if ($result_to_account != 1) 
        {
        ...
        //elseif($loan_amount > 20000 || $loan_amount < 500)
        //{
          //  echo '<script type="text/JavaScript">  
            //  amountLimit();
             //</script>' 
        ...
        {
            $query_for_insert_request = "INSERT INTO `tbl_loan`(`account_no`, `loan_amount`, `annual_income`, `purpose`, `full_name`, `email`, `mobile`, `occupation`, `hasViewed`, `status`, `request_date`) VALUES ($account_num, $loan_amount, $annual_income,'$purpose','$fullname','$email','$mobile','$occupation','$hasViewed','$status','$Req_date')";
