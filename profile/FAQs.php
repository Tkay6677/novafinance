                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-5">
                                                        <div class="faq-box media mt-4">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="font-size-15">What is NovaFinance ?<br></h5>
                                                                <p class="text-muted"><span class="js-about-item-abstr">NovaFinance, also known as internet
                                                    ...
                                                    <div class="col-lg-5 offset-lg-1">
                                                        <div class="faq-box media mt-4">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p>
                                                                <ol><li class="text-muted">Log in to the account and go to Add Money<br></li><li class="text-muted">Click to new request and enter Ben. Account no. and amount and hit enter.<br></li><li class="text-muted">Remember you can send money request up to 20,000 per time and minimum transaction limit is 500.</li></ol>
                                                        ...
                                                        <div class="faq-box media mt-4">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p>
                                                                <ol><li class="text-muted">Log in to the account and go to Add Money<br></li><li class="text-muted">in Inbox you can see all request you receives<br></li><li class="text-muted">open request that you want to transfer and click to send button to approve request.<br></li></ol>
</p>
                                                            </div>
                                                        </div>
                                                        <div class="faq-box media mt-4">
