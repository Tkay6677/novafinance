    ...
    if(isset($_SESSION["s_admin_id"]))
    {
        ...
        if(isset($_GET['operationType'])) {
            ...
            if($manage_oprationType == "credit") {
                echo '<script> alert("credit alert") </script>';
                ...
                if ($Amount > $Acount_bal) {
                    ...
                    // echo '<script> alert(" alert debit") </script>';
                    ...
                    echo '<script> alert(" alert credit") </script>';
        ...
        <div id="layout-wrapper">
            ...
            <header id="page-topbar" >
                <div class="navbar-header">
                    <div class="d-flex">
                        <!-- LOGO -->
                        <div class="navbar-brand-box" style = "background-color: #00204a !important">
                            <a href="index.php" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="assets/images/logo-sm-dark.png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/images/favicon.ico" alt="" height="20">
                                    NovaFinance 
                                </span>
                            </a>
                            ...
                            <a href="index.php" class="logo logo-light">
                                ...
                                <span class="logo-lg text-white mb-0">
                                   
                                   <img src="assets/images/old-favicon.ico" alt="" height="20">
                                   NovaFinance 
            ...
            <!-- ========== Left Sidebar Start ========== -->
            <div class="vertical-menu" style = "background-color: #00204a !important">
