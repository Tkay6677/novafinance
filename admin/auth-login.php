...
<html lang="en">
  ...
  <body class="bg-primary bg-pattern" style = "background-color: #00204a !important">
    <div class="home-btn d-none d-sm-block">
            <a href="auth_login.php"><i class="mdi mdi-home-variant h2 text-white"></i></a>
        </div>
            ...
            <div class="text-center mb-5">
              <div clas="row">
                <h5 class="font-size-20 text-white mb-4">
                  <img src="assets/images/old-favicon.ico" height="24" alt="logo" />
                 NovaFinance
                </h5>
              </div>
              ...
              <div class="card-body p-4">
                <div class="p-2">
                  <h5 class="mb-5 text-center">
                    Sign in to continue to NovaFinance.
                  </h5>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="mt-4">
                          <button
                            ...
                            type="submit"
                            name="btn_submit"
                            style = "background-color: #00204a !important"
                          >
                            Log In
                          </button>
                        </div>
